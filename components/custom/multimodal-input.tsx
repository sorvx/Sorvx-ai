            ...
            {suggestedActions.map((suggestedAction, index) => (
              ...
              >
                <button
                  ...
                  className="border-none bg-muted/50 max-w-[75%] text-left border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-300 rounded-lg p-3 text-sm hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors flex flex-col"
                >
