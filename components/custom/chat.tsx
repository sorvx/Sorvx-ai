    ...
    <div className="min-h-screen bg-background flex flex-col">
      <main className="flex flex-col h-screen pt-14 sm:pt-16 pb-4 px-4 sm:px-6">
        <div className="flex flex-col h-full items-center w-full max-w-2xl mx-auto">
          {/* Messages Container */}
          <div ref={messagesContainerRef} className="flex flex-col gap-2 w-full grow overflow-y-auto">
          ...
          {/* Input Form */}
          <form className="flex flex-row gap-2 items-end w-full max-w-2xl mt-2" onSubmit={handleSubmit}>
            <MultimodalInput
              input={input}
              setInput={setInput}
